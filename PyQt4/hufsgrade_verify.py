...
class Window(QtGui.QMainWindow):
    ...
    def login(self):
        ...
        self.current_session.post(login_url, data=params, headers=head, verify=False)
        
        #-------------------------학생정보--------------------------#
        self.current_session.get(main_page, headers=head, verify=False)

        self.studentinfo = self.current_session.get(studentinfo_url, headers=head, verify=False)
        ...
        self.graduateinfo=self.current_session.get(credits_url,headers=head, verify=False)
        ...
        self.creditsinfo=self.current_session.get(credits_list_url,headers=head, verify=False)
