...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("HUFSGrade_ver1.6 2016-09-22")
...
<br>
<br>A. 호환성 문제입니다. 다음과 같은 방법으로 쉽게 해결 가능합니다.
<br>
<br>hufsgrade_ver1.x.exe 실행파일 마우스 우클릭 - 속성 - 호환성 - 호환 모드 - 이 프로그램을 실행할 호환 모드 [체크] - 본인 PC의 운영체제 선택 - 완료
</p>
""")
